...
class HtMsgFlatrateInvoiceAccepted extends TkLocalizerMixin(PolymerElement) {
    static get template() {
        return html`
...
`;
    ...
    static get is() {
        return 'ht-msg-flatrate-invoice-accepted';
    }
...
customElements.define(HtMsgFlatrateInvoiceAccepted.is, HtMsgFlatrateInvoiceAccepted);
