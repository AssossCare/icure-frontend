...
class HtMsgFlatrateInvoiceArchived extends TkLocalizerMixin(PolymerElement) {
    static get template() {
        return html`
...
`;
    ...
    static get is() {
        return 'ht-msg-flatrate-invoice-archived';
    }
...
customElements.define(HtMsgFlatrateInvoiceArchived.is, HtMsgFlatrateInvoiceArchived);
