...
class HtMsgFlatrateInvoiceBatchDetail extends TkLocalizerMixin(PolymerElement) {
    static get template() {
        return html`
...
`;
    ...
    static get is() {
        return 'ht-msg-flatrate-invoice-batch-detail';
    }
                ...
                .then((attachs) => {
                    ...
                    attachs.forEach( a => {
                        ...
                        if(!_.isEmpty(_.get(a, 'message', {}))) {
                            ...
                            let errorString = ''
                            Object.keys(_.get(zone1and90, 'errorDetail', [])? _.get(zone1and90, 'errorDetail', []) : []).find(key => {
...
customElements.define(HtMsgFlatrateInvoiceBatchDetail.is, HtMsgFlatrateInvoiceBatchDetail);
