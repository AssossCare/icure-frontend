...
`;
    ...
    static get is() {
        return 'ht-msg-flatrate-invoice-pending';
    }
    ...
    receiveInvoices() {
        ...
        if (mayGet) {
            ...
            this.api.fhc().Efactcontroller().loadMessagesUsingGET(_.get(this.hcp, 'nihii', null), this.language, _.get(this.api, 'keystoreId', null), _.get(this.api, 'tokenIdMH', null), _.get(this.api, 'credentials.ehpassword', null), _.get(this.hcp, 'ssin', null), _.get(this.hcp, 'firstName', null), _.get(this.hcp, 'lastName', null)).then( x => this.api.logMcn(x, this.user, this.hcp.id, "eFact", "loadMessages") ).then(response => {
                ...
                prom = prom.then(treatedMessages => {
                    ...
                    _.chunk(treatedMessages, 20).forEach(chunk => {
                        ...
                        sprom = sprom
                            .then(() =>this.api.fhc().Efactcontroller().confirmAcksUsingPUT(_.get(this.hcp, 'nihii', null), _.get(this.api, 'keystoreId', null), _.get(this.api, 'tokenIdMH', null), _.get(this.api, 'credentials.ehpassword', null), _.get(this.hcp, 'ssin', null), _.get(this.hcp, 'firstName', null), _.get(this.hcp, 'lastName', null), tacks.map(t => t.hashValue)))
                            .then(() => this.api.fhc().Efactcontroller().confirmMessagesUsingPUT(_.get(this.hcp, 'nihii', null), _.get(this.api, 'keystoreId', null), _.get(this.api, 'tokenIdMH', null), _.get(this.api, 'credentials.ehpassword', null), _.get(this.hcp, 'ssin', null), _.get(this.hcp, 'firstName', null), _.get(this.hcp, 'lastName', null), responses.map(t => t.hashValue)))
...
customElements.define(HtMsgFlatrateInvoicePending.is, HtMsgFlatrateInvoicePending);
