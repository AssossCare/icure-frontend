            ...
            this.api.fhc().Efact().loadMessagesUsingGET(_.get(this.hcp, 'nihii', null), this.language, _.get(this.api, 'keystoreId', null), _.get(this.api, 'tokenIdMH', null), _.get(this.api, 'credentials.ehpassword', null), _.get(this.hcp, 'ssin', null), _.get(this.hcp, 'name', null), "", "medicalhouse").then( x => this.api.logMcn(x, this.user, this.hcp.id, "eFact", "loadMessages") ).then(response => {
                ...
                prom = prom.then(treatedMessages => {
                    ...
                    _.chunk(treatedMessages, 20).forEach(chunk => {
                        ...
                        sprom = sprom
                            .then(() =>this.api.fhc().Efact().confirmAcksUsingPUT(_.get(this.hcp, 'nihii', null), _.get(this.api, 'keystoreId', null), _.get(this.api, 'tokenIdMH', null), _.get(this.api, 'credentials.ehpassword', null), _.get(this.hcp, 'ssin', null), _.get(this.hcp, 'name', null), _.get(this.hcp, 'lastName', ""), "medicalhouse", tacks.map(t => t.hashValue)))
                            .then(() => this.api.fhc().Efact().confirmMessagesUsingPUT(_.get(this.hcp, 'nihii', null), _.get(this.api, 'keystoreId', null), _.get(this.api, 'tokenIdMH', null), _.get(this.api, 'credentials.ehpassword', null), _.get(this.hcp, 'ssin', null), _.get(this.hcp, 'name', null), _.get(this.hcp, 'lastName', ""), "medicalhouse", responses.map(t => t.hashValue)))
