...
class HtMsgFlatrateInvoiceRejected extends TkLocalizerMixin(PolymerElement) {
    static get template() {
        return html`
...
`;
    ...
    static get is() {
        return 'ht-msg-flatrate-invoice-rejected';
    }
...
customElements.define(HtMsgFlatrateInvoiceRejected.is, HtMsgFlatrateInvoiceRejected);
