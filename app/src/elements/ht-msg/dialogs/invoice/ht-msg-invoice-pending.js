            ...
            this.api.fhc().Efact().loadMessagesUsingGET(
                ...
                prom = prom.then(treatedMessages => {
                    ...
                    _.chunk(treatedMessages, 20).forEach(chunk => {
                        ...
                        sprom = sprom
                            .then(() =>this.api.fhc().Efact().confirmAcksUsingPUT(this.hcp.nihii, this.api.keystoreId, this.api.tokenId, this.api.credentials.ehpassword, this.hcp.ssin, this.hcp.firstName, this.hcp.lastName, tacks.map(t => t.hashValue)))
                            .then(() => this.api.fhc().Efact().confirmMessagesUsingPUT(this.hcp.nihii, this.api.keystoreId, this.api.tokenId, this.api.credentials.ehpassword, this.hcp.ssin, this.hcp.firstName, this.hcp.lastName, responses.map(t => t.hashValue)))
