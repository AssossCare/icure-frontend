                                    ...
                                    <template is="dom-repeat" items="[[_resolvedPatientsForSuggestedAssignments]]" as="item">
                                        <div class="singleAssignment">
                                            ...
                                            <div class="documentTypeComboBoxContainer">
                                                ...
                                                <paper-input id$="documentTitleSuggestion-[[item.documentId]]-[[item.patientData.id]]"  placeHolder="[[localize('doc-title','Titre du document',language)]]" label="[[localize('doc-title','Titre du document',language)]]"></paper-input>
                                            </div>
                            ...
                            <template is="dom-if" if="[[_totalRemainingAnnexesToAssignForCurrentDoc]]">
                                ...
                                <template is="dom-repeat" items="[[_manualSearchResultsForAssignments]]" as="item">
                                    <div class="singleAssignment">
                                        ...
                                        <div class="documentTypeComboBoxContainer">
                                            <span class="documentTypeLabel">[[localize('ehb.assignmentDocumentType','Document type',language)]]:</span><vaadin-combo-box id\$="documentType-[[item.documentId]]-[[item.patientData.id]]" class="documentTypeComboBox" filtered-items="[[_transactionCodes]]" item-label-path="name" item-value-path="code" value="[[item.documentType]]"></vaadin-combo-box>
                                            <paper-input id$="documentTitleManual-[[item.documentId]]-[[item.patientData.id]]"  placeHolder="[[localize('doc-title','Titre du document',language)]]" label="[[localize('doc-title','Titre du document',language)]]"></paper-input>
                                        </div>
