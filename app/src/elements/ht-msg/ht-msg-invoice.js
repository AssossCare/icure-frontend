  ...
  ready() {
    ...
    */
    ...
    dispatchMessages() {
        ...
        !!this.set("messagesAccepted", _.get(this, 'allMessages', []).filter( m => (_.get(m, 'message.status', null) & (1 << 15 | 1 << 16 )) !== 0 && !(_.get(m, 'message.status', null) & (1<<21))))
        !!this.set("messagesRejected", _.get(this, 'allMessages', []).filter( m => (_.get(m, 'message.status', null) & (1 << 17)) !== 0 && !(_.get(m, 'message.status', null) & (1<<21))))

        !!this.initializeBatchCounter(this.selectedInvoicesToBeSend.length ? this.selectedInvoicesToBeSend.length : 0, this.messagesToBeCorrected.length ? this.messagesToBeCorrected.length : 0 , _.get(this, 'allMessages', []).filter(m => (_.get(m, 'message.status', null) & (1 << 15 | 1 << 16 | 1 << 17)) === 0 && !(_.get(m, 'message.status', null) & (1<<21))).length, _.get(this, 'allMessages', []).filter( m => (_.get(m, 'message.status', null) & (1 << 15 | 1 << 16 )) !== 0 && !(_.get(m, 'message.status', null) & (1<<21))).length, _.get(this, 'allMessages', []).filter( m => (_.get(m, 'message.status', null) & (1 << 17)) !== 0 && !(_.get(m, 'message.status', null) & (1<<21))).length, _.get(this, 'allMessages', []).filter( m => (_.get(m, 'message.status', null) & (1 << 21)) !== 0).length)
    }
