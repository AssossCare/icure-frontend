    ...
    _sendFormUsingEhBox(parsedXml) {
        ...
        return !_.size(parsedXml) ? promResolve : promResolve
            ...
            .then(message => {
                ...
                return this.api.fhc().Ehbox().sendMessageUsingPOST(_.get(this, "api.keystoreId", null), _.get(this, "api.tokenId", null), _.get(this, "api.credentials.ehpassword", null), message, _.get(message,"usePublicationReceipt",false), _.get(message,"useReceivedReceipt",true), _.get(message,"useReadReceipt",false)).catch(e => e)
            })
            .catch(e => null)
