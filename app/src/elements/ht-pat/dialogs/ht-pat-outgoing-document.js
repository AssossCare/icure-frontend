...
`
    ...
    _saveMedexIttToPatFile() {
        ...
        return this.api.message().newInstanceWithPatient(_.get(this, "user", {}), _.get(this, "_data.currentPatient", {}))
            ...
            .then(([createdMessage, createdDocument]) => this.api.encryptDecrypt("encrypt", _.get(this, "user", {}), createdDocument, _.get(this, "_data.pdf.data", "")).then(encryptedFileContent => [createdMessage, createdDocument, encryptedFileContent]))
        ...
        return this._print({forceReturnFile: true})
            .then(([printedPdf, fileName]) => {
                ...
                return this.api.message().newInstanceWithPatient(_.get(this, "user", {}), _.get(this, "patient", {}))
                    ...
                    .then(createdDocument => this.api.encryptDecrypt("encrypt", _.get(this, "user", {}), createdDocument, printedPdf).then(encryptedFileContent => [createdDocument, encryptedFileContent]))
