...
class HtPatPrescriptionDetailCheaperDrugs extends TkLocalizerMixin(mixinBehaviors([IronResizableBehavior], PolymerElement)) {
    static get template() {
        return html`
        <style include="dialog-style scrollbar-style buttons-style shared-styles paper-tabs-style atc-styles spinner-style">
         ...
         <div class="cheaper-drugs-container">
            ...
            <div class="cheaper-drugs-container-content">
                ...
                <template is="dom-if" if="[[!isLoading]]" restamp="true">
                    <template is="dom-if" if="[[_isResult(cheaperDrugsList)]]">
                        <div class="table">
                                <div class="tr th">                 
                                ...
                                <template is="dom-repeat" items="[[cheaperDrugsList]]" as="drug">
                    ...
                    <template is="dom-if" if="[[!_isResult(cheaperDrugsList)]]">
                        <div class="no-alternative">
                            [[localize('no_alt', 'No alternative', language)]]
                        </div>
                    </template>      
                </template>             
            </div>
...
`;
    ...
    static get is() {
        return 'ht-pat-prescription-detail-cheaper-drugs';
    }
