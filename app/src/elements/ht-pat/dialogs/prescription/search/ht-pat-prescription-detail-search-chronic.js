...
`;
    ...
    static get is() {
        return 'ht-pat-prescription-detail-search-chronic';
    }
    ...
    _openPosologyView(e){
        ...
        const product = _.find(_.get(this, 'searchResult.chronic', []), it => _.trim(_.get(it,"internalUuid","")) === internalUuid)
...
customElements.define(HtPatPrescriptionDetailSearchChronic.is, HtPatPrescriptionDetailSearchChronic);
