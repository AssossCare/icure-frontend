                 ...
                 <div class="table">
                    ...
                    <template is="dom-repeat" items="[[searchResult.history]]" as="drug">
                        <div class="tr tr-item">
                            <div class="td fg01"><iron-icon class="addIcon" icon="icons:add" data-id$="[[drug.id]]" data-internaluuid$="[[drug.internalUuid]]" data-type="history" on-tap="_openPosologyView"></iron-icon></div>    
