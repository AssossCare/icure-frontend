                ...
                if(_.get(notifySubscriptionClosureResponse, 'reference', null)){
                    ...
                    Promise.all([
                        ...
                        .then(([xades,soap,request,response, soapRequest]) => Promise.all([
                            _.get(xades,"id",false) && _.get(notifySubscriptionClosureResponse,"xades",false) && this.api.receipt().setAttachment(xades.id, "xades", undefined, (this.api.crypto().utils.ua2ArrayBuffer(this.api.crypto().utils.text2ua(atob(notifySubscriptionClosureResponse.xades))))) || Promise.resolve(xades),
                            _.get(soap,"id",false) && _.get(notifySubscriptionClosureResponse,"mycarenetConversation.soapResponse",false) && this.api.receipt().setAttachment(soap.id, "soapResponse", undefined, (this.api.crypto().utils.ua2ArrayBuffer(this.api.crypto().utils.text2ua(notifySubscriptionClosureResponse.mycarenetConversation.soapResponse)))) || Promise.resolve(soap),
                            _.get(request,"id",false) && _.get(notifySubscriptionClosureResponse,"mycarenetConversation.transactionRequest",false) && this.api.receipt().setAttachment(request.id, "kmehrRequest", undefined, (this.api.crypto().utils.ua2ArrayBuffer(this.api.crypto().utils.text2ua(notifySubscriptionClosureResponse.mycarenetConversation.transactionRequest)))) || Promise.resolve(request),
                            _.get(response,"id",false) && _.get(notifySubscriptionClosureResponse,"mycarenetConversation.transactionResponse",false) && this.api.receipt().setAttachment(response.id, "kmehrResponse", undefined, (this.api.crypto().utils.ua2ArrayBuffer(this.api.crypto().utils.text2ua(notifySubscriptionClosureResponse.mycarenetConversation.transactionResponse)))) || Promise.resolve(response),
